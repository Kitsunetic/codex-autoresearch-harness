...
```text
$codex-autoresearch-harness reduce error_count de `python3 scripts/score.py` a 0
```
...
| Control | Pausa/reanudación del Goal | Status/stop/resume con `$codex-autoresearch-harness` |
